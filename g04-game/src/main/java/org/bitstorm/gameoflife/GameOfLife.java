...
public class GameOfLife extends Applet implements Runnable, GameOfLifeControlsListener {
    ...
    private final Logger log = StandaloneGameOfLife.getLoggerSetup().getLogger("GameOfLife");
    ...
    public void init() {
        ...
        try {
            // Start with a shape (My girlfriend clicked "Start" on a blank screen and
    ...
    public synchronized void run() {
        while (gameThread != null) {
            ...
            try {
                ...
                // TODO abklaeren ob noetig e.printStackTrace();
                log.error("Interrupt in Run method" + e);
            }
        }
    }
     ...
     *
     * @see org.bitstorm.gameoflife.GameOfLifeControlsListener#startStopButtonClicked
     ...
     * Callback from GameOfLifeControlsListener.
     *
     * @see org.bitstorm.gameoflife.GameOfLifeControlsListener#nextButtonClicked
     *      (org.bitstorm.gameoflife.GameOfLifeControlsEvent)
     */
    @Override
     ...
     * Callback from GameOfLifeControlsListener.
     *
     * @see org.bitstorm.gameoflife.GameOfLifeControlsListener#speedChanged
     *      (org.bitstorm.gameoflife.GameOfLifeControlsEvent)
     */
    @Override
     ...
     * Callback from GameOfLifeControlsListener.
     *
     * @see org.bitstorm.gameoflife.GameOfLifeControlsListener#shapeSelected
     *      (org.bitstorm.gameoflife.GameOfLifeControlsEvent)
     */
    @Override
