...
/**
 * Listener interface for GameOfLifeControls. The idea behind this interface is
 * that the controls can be replaced by something else for e.g. smart phones and
 * PDA's.
 *
