...
/**
 * Event class for GameOfLifeControls. Can pass speed, cellSize and shapeName.
 * Objects from this class are generated by GameOfLifeControls
 *
 * @see GameOfLifeControls
 * @author Edwin Martin
 */
public final class GameOfLifeControlsEvent extends Event {
     ...
     * @return new event object
     */
    public static GameOfLifeControlsEvent getShapeSelectedEvent(final Object source, final String shapeName) {
        GameOfLifeControlsEvent event = new GameOfLifeControlsEvent(source);
